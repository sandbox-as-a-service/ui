...
export const Showcase: Story = {
  render: () => (
    <div className="w-full flex flex-col items-center gap-12 py-12">
      <TypographyH1>
        Typography H1 — The quick brown fox jumps over the lazy dog
      </TypographyH1>
      ...
      <TypographyLead>
        This is a lead paragraph — larger and muted to introduce a section.
      </TypographyLead>
      <TypographyInlineCode>pnpm add @your/pkg</TypographyInlineCode>
      <TypographyP>
        A secondary paragraph under the H2 to demonstrate spacing and rhythm.
      </TypographyP>
      <TypographyBlockquote>
        This is a blockquote to show emphasized or quoted text. It should be
        styled with an italic font and a left border.
      </TypographyBlockquote>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows all named typography exports from `typography.tsx` in one place for visual reference.",
      },
    },
  },
};
